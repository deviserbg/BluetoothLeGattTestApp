...
public class DeviceScanActivity extends ListActivity {
    ...
    private static final int test_new = 0;
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            Integer flag = mAdvert.get(device.getAddress());

            if (flag > 0) {

                viewHolder.deviceAdvertising.setText(String.valueOf(flag));
            } else {
...
//                        sr.getAdvertiseFlags();
    ...
    private void parseAdvertisementPacket(final byte[] scanRecord) {
        ...
        byte[] MfgData = Arrays.copyOf(scanRecord, scanRecord.length);
                ...
                case 0x07:// Complete list of 128-bit UUIDs
                    ...
                    while (len >= 16) {
                        try {
                            ...
                            Log.e("BTDFilter.parseUUID", e.toString());
                            continue;
                        } finally {
